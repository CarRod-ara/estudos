...
int main(void)
{
    ...
    {
		cout<<"Olá a todos esse é um pequeno projeto de quiz que estou desenvolvendo"<<endl<<endl;
        cout<<"caso queiram ver mais coisas minhas segue o link:"<<endl<<endl;
		cout<<"linktr.ee/C.Rodrigues.a"<<endl<<endl;
		...
		{		
			...
			{
				DV=3;
				cout<<"o intuito do projeto é auxiliar a criação do meu portifolio enquanto revejo o que aprendi"<<endl;
				...
				if (v==1)
				{
					cout<<"I - Qual das linguagens tem mais linhas de código?"<<endl;
					...
					if(v==1 || DV>0)
					{
						cout<<"II - Qual objetivo principal do projeto"<<endl;
						cout<<"1) resolver um problema"<<endl;
						cout<<"2) hackear a receia federal"<<endl;
						cout<<"3) criar um portifolio"<<endl;
						cout<<"número: ";
						cin>>r;
						R3(r,v);
						vidas(v, DV);
						...
						if(v==1 || DV>0)
						{
							cout<<"III - Qual a melhor linguagem de programação?"<<endl;
							cout<<"1) A que paga suas contas"<<endl;
							cout<<"2) C++"<<endl;
							cout<<"3) Java"<<endl;
							cout<<"número: ";
							cin>>r;
